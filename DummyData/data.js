...
const music = (req,res) => {
    res.json([
        ...
        },
        {
            ...
            released their 2nd studio album Cleopatra on April 8, 2016. The black and white photo on the cover depicts 
            silent movie star Theda Bara in the title role in the 1917 film Cleopatra. The album's first single "Ophelia" 
            was released on February 5, 2016. Ophelia ended up being 2016's Billboard's #1 Alternative song and #1 Rock  
            Radio song. The second single, also the album's title track, "Cleopatra", sprang from an encounter with a 
            taxi driver Wes met in the Republic of Georgia, who told a story of personal tragedy without a trace of
            self-pity. The 3rd single, "Angela", quickly rose to No. 2 on Triple A radio making "Cleopatra" the first
            independent album to have three Top-5 singles at Alternative radio. In April 2017, the band released the
            short film "The Ballad of Cleopatra", which brought together videos for the songs "Cleopatra", "Angela",
            "Ophelia", "Sleep on the Floor" and "My Eyes". The film depicts Cleopatra's life story in one continuous
            narrative. My personal favourite is "Sleep on the Floor" because of its addictive pre-chorus and lyrics.
            Each song in this album has a story of its own and is connected to one another, thus making it unique. 
            Hope you enjoy this album as much as I did.`
        }
    ])
}
...
const animes = (req,res) => {
    res.json([
        ...
        },
        {
            ...
            description:`Spirited Away tells the story of Chihiro Ogino, a 10-year-old girl who enters the world of Kami`,
